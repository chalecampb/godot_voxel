...
Runs a custom [VoxelGraphScriptNode](api/VoxelGraphScriptNode.md) resource backed by a script contract. Inputs, outputs, and parameters are defined by the assigned script.
