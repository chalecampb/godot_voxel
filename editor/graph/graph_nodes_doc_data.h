...
static const Node g_data[COUNT] = {
    ...
    {"ScriptGraphNode", "Functions", "Runs a custom [url=VoxelGraphScriptNode]VoxelGraphScriptNode[/url] resource backed by a script contract. Inputs, outputs, and parameters are defined by the assigned script."},
