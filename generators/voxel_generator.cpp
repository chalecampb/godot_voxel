...
const char *VoxelGenerator::SIGNAL_REGENERATION_REQUESTED = "regeneration_requested";
...
void VoxelGenerator::_bind_methods() {
	...
	ClassDB::bind_method(D_METHOD("request_regeneration"), &VoxelGenerator::request_regeneration);

	ADD_SIGNAL(MethodInfo(SIGNAL_REGENERATION_REQUESTED));
}
